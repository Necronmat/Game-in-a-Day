...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACamera_Statics::NewProp_mScene = { "mScene", nullptr, (EPropertyFlags)0x0040000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACamera, mScene), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACamera_Statics::NewProp_mScene_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACamera_Statics::NewProp_mScene_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACamera_Statics::NewProp_mSpringArm = { "mSpringArm", nullptr, (EPropertyFlags)0x0040000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACamera, mSpringArm), Z_Construct_UClass_USpringArmComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACamera_Statics::NewProp_mSpringArm_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACamera_Statics::NewProp_mSpringArm_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACamera_Statics::NewProp_mCamera = { "mCamera", nullptr, (EPropertyFlags)0x0040000000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACamera, mCamera), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACamera_Statics::NewProp_mCamera_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACamera_Statics::NewProp_mCamera_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_GameInADay_Source_GameInADay_Camera_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameInADay_Source_GameInADay_Camera_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACamera, ACamera::StaticClass, TEXT("ACamera"), &Z_Registration_Info_UClass_ACamera, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACamera), 3695194734U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_GameInADay_Source_GameInADay_Camera_h_2092410533(TEXT("/Script/GameInADay"),
		Z_CompiledInDeferFile_FID_GameInADay_Source_GameInADay_Camera_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_GameInADay_Source_GameInADay_Camera_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
