...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ABoard_Statics::NewProp_mSpace = { "mSpace", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ABoard, mSpace), Z_Construct_UClass_UClass, Z_Construct_UClass_ASpace_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABoard_Statics::NewProp_mSpace_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABoard_Statics::NewProp_mSpace_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ABoard_Statics::NewProp_mChessPiece = { "mChessPiece", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ABoard, mChessPiece), Z_Construct_UClass_UClass, Z_Construct_UClass_AChessPiece_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ABoard_Statics::NewProp_mChessPiece_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABoard_Statics::NewProp_mChessPiece_MetaData)) };
	...
	ABoard::~ABoard() {}
	struct Z_CompiledInDeferFile_FID_Users_User_Desktop_Uni_work_UClan_Masters_Advance_Games_Game_in_a_Day_GameInADay_Source_GameInADay_Board_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Uni_work_UClan_Masters_Advance_Games_Game_in_a_Day_GameInADay_Source_GameInADay_Board_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABoard, ABoard::StaticClass, TEXT("ABoard"), &Z_Registration_Info_UClass_ABoard, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABoard), 3254041382U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_User_Desktop_Uni_work_UClan_Masters_Advance_Games_Game_in_a_Day_GameInADay_Source_GameInADay_Board_h_2036401611(TEXT("/Script/GameInADay"),
		Z_CompiledInDeferFile_FID_Users_User_Desktop_Uni_work_UClan_Masters_Advance_Games_Game_in_a_Day_GameInADay_Source_GameInADay_Board_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_User_Desktop_Uni_work_UClan_Masters_Advance_Games_Game_in_a_Day_GameInADay_Source_GameInADay_Board_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
